(function() {
  ...
  ProjectMergeRequests = (function(superClass) {
    ...
    ProjectMergeRequests.prototype.init = function() {
      return this.notes = this.load('ProjectMergeRequestNotes');
    };
    ...
    ProjectMergeRequests.prototype.comment = function(projectId, mergerequestId, note, fn) {
      ...
      return this.notes.add(projectId, mergerequestId, note, (function(_this) {
        return function(data) {
          if (fn) {
            return fn(data);
          }
